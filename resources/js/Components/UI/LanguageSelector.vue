            ...
            <div class="grid grid-cols-3 py-6">
                <div class="relative my-4 flex items-center justify-center">
                    <div class="relative">
                        ...
                        />
                        <div
                            class="border-gray-200 peer-checked:border-primary-500 dark:border-gray-600 flex h-14 w-14 items-center justify-center rounded-full border-2 shadow-lg transition-all duration-300"
                        >
                            <img
                        ...
                        <div
                            class="bg-primary-500 dark:border-gray-800 absolute -end-1 -top-1 hidden h-7 w-7 items-center justify-center rounded-full border-4 border-white text-white peer-checked:flex"
                        >
                            <svg
                                data-v-26e5b7b0=""
                                xmlns="http://www.w3.org/2000/svg"
    ...
    mounted() {
        if (document.getElementById("drawer-language")) {
            ...
            this.drawer = new Drawer(
                document.getElementById("drawer-language"),
                options
            );
        }
