            ...
            <div class="flex items-center justify-between">
                ...
                <div v-if="!simple" class="flex items-center py-3">
                    ...
                    <div v-if="!isAuthenticated" class="flex ml-5">
                        <button @click.prevent="loginToggle">{{ $t('Log in') }}</button>
            ...
            <div class="flex md:justify-between">
                ...
                <div class="w-full relative p-5">
                    ...
                    <form @submit.prevent="loginSubmit" method="post" action="" class="">
                        ...
                        <p class="text-sm text-gray-500 dark:text-gray-300 mb-6">New here? <a href="" @click.prevent="hideLoginShowRegisterToggle"><strong>Create account</strong></a></p>
                    </form>
...
export default {
    ...
    mounted() {
        ...
        * options: optional
        */
        this.domainStore.fetchDomainInfo();
        this.domainInfo = this.domainStore.domainInfo;
