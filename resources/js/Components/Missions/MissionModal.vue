    ...
    >
        <div class="relative p-4 w-full max-w-2xl max-h-full">
            ...
            <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                <!-- Modal header -->
                <div
                    class="flex items-center justify-between p-4 md:p-5 border-b rounded-t dark:border-green-700"
                >
                    <h3
                        class="text-xl font-semibold text-gray-900 dark:text-white flex flex-col"
                    >
                        {{ $t("Mission Center") }}
                    </h3>
                    <button
                        @click.prevent="toggleMissionModal"
                        type="button"
                        class="text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 dark:bg-gray-600 rounded-lg text-sm w-8 h-8 ms-auto inline-flex justify-center items-center dark:hover:bg-gray-800 dark:hover:text-white"
                    >
                        <svg
                            class="w-3 h-3"
                            aria-hidden="true"
                ...
                <div class="p-4 md:p-5 space-y-4 top-custom">
                    <div class="flex justify-between">
                        <div class="">
                            ...
                            <h4 class="text-2xl font-extrabold italic">
                                $ 0,00
                            </h4>
                        </div>
                        <div class="">
                    ...
                    >
                        <ul
                            class="flex justify-between -mb-px text-sm font-medium text-center text-gray-500 dark:text-gray-400"
                            id="tabs-mission"
                            role="tablist"
                        >
...
export default {
    ...
    mounted() {
        ...
        const optionsTab = {
            ...
            activeClasses:
                "active-tab text-green-600 hover:text-blue-600 dark:text-green-500 dark:hover:text-green-400 border-green-600 dark:border-green-500",
            inactiveClasses:
