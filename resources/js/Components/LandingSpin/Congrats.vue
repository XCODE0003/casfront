<template>
    <div class="congrats" :class="{ show: prize }">
        ...
        <div id="congrats-content">
            <img
                class="img-bg rotate"
                :src="'/assets/images/spin/4fea7639.webp'"
                alt=""
            />
            <div class="bg-wrap">
                <img
                    class="img_glod"
                    :src="'/assets/images/spin/7f96d3f0.webp'"
                    alt=""
                />
                <div class="cont">
                    <div class="tit ttu">{{ $t("Congratulations") }}!</div>
                    <div class="desc">
                        {{ $t("You’ve got free money to bet on our games") }}!
                    </div>
                    <div class="scoll-num amount sxm7p3g">
                        <span v-if="prize.currency == 'USD'">$&nbsp;</span
                        >{{ animatedNumber.toFixed(2).replace(".", ",") }}
                        <span v-if="prize.currency != 'USD'">{{
                            prize.currency
                        }}</span>
                    </div>
                    <button
                        class="ui-button button-normal s-conic"
                        @click="ClaimReawards()"
                    >
