    ...
    <GameLayout>
        <div :class="{ 'w-full': modeMovie, 'lg:w-2/3': !modeMovie }"
            ...
            <div class="game-screen rounded-xl">
                <div class="flex h-full flex-col mx-auto items-center gap-4" style="max-width: 400px">
                    <div class="grid flex-shrink-0 h-full grid-cols-5 gap-2 game-tiles"
                        ...
                        <div class="game-tile" v-for="(item, index) in 25" :key="index"
                            :class="minesStore.getCellClass(index)" @click="minesStore.pick(index)">
                            <div class="game-tile__inner-possible-win">
                                ${{ (Math.round(minesStore.next_win * 10) / 10).toFixed(1) }}
                            </div>
                            <div class="game-tile__inner">
                                <div v-if="minesStore.getResult(index) === true" class="diamond"></div>
                                <div v-if="minesStore.getResult(index) === false" class="bomb"></div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="flex justify-between items-center">
                            <div class="flex flex-col gap-1">
                                ...
                                <input
                                    ...
                                    placeholder="Enter your bet" v-model="minesStore.game_settings.bet" />
                            </div>
                            <div class="flex items-center p-2 bg-gray-900 rounded-xl gap-1">
                                <div data-track="" @click="minesStore.removeMines()"
                                    class="button _sm _golden w-11 h-11">
                                    <div class="button__inner">
                                        <div class="button__text">-</div>
                                    </div>
                                </div>
                                <div class="px-3 gap-1 flex flex-col items-center">
                                    <div class="text-orange leading-none text-[10px]">
                                        Mines
                                    </div>
                                    <div class="font-bold text-xl leading-none text-orange">
                                        {{ minesStore.getGameSettings.mines }}
                                    </div>
                                </div>
                                <div data-track="" class="button _sm _golden w-11 h-11" @click="minesStore.addMines()">
                                    <div class="button__inner">
                                        <div class="button__text">+</div>
                                    </div>
                                </div>
                    ...
                    <div :class="minesStore?.activeGame ? '_cancel' : '_placebet',
                        minesStore?.game_settings.bet > 0
                            ? ''
                            : '_disabled'
                            ...
                            <div class="btn-new__inner">
                                ...
                                <div class="btn-new__text">
                                    <div class="text-wrapper">
                                        <div class="text">
                                            {{
                                                minesStore?.activeGame
                                                    ? "Stop Game"
                                                    : "Start Game"
                                            }}
                                        </div>
                                    </div>
                                    <div :class="minesStore?.activeGame
                                        ? '_cancel'
                                        : '_placebet'
                                        " class="indicator"></div>
                                </div>
            ...
            <div id="tabContentExample">
                    ...
                    <div class="flex w-full">
                        <div class="w-full flex flex-col lg:flex-row justify-between">
                            <div class="w-full flex">
                                <div class="flex">
                                    <img :src="`/assets/images/games/mines.png`" alt="Mines"
                                        class="w-full h-32 rounded-xl" />
                                </div>
                                <div class="p-4">
                                    <p class="text-2xl">Mines</p>
                                    <p class="text-[12px]">
                                        by
                                        <span class="font-bold text-white">In-house</span>
                                    </p>
                                    <p>2024</p>
                                </div>
                            </div>
                            <div class="w-full mt-0 lg:mt-5">
                                ...
                                <div class="mt-3 grid grid-cols-2 gap-1">
                                    <div class="p-3 bg-gray-700 flex justify-between">
                                        <p>RTP (Возврат игроку)</p>
                                        <p class="text-green-500">95%</p>
                                    </div>
                                    <div class="p-3 bg-gray-700 flex justify-between">
                                        <p>Провайдер</p>
                                        <p class="text-green-500">In-house</p>
                                    </div>
                                    <div class="p-3 bg-gray-700 flex justify-between">
                                        <p>Макс. выигрыш</p>
                                    ...
                                    <div class="p-3 bg-gray-700 flex justify-between">
                                        <p>Тип</p>
                                        <p class="text-green-500">Mines</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="hidden rounded-lg bg-gray-50 p-4 dark:bg-gray-800" id="description-panel" role="tabpanel">
                    <p>
                        Классическая игра Mines - найдите безопасные клетки и
                        избегайте мин!
                    </p>
                </div>
                <div class="hidden rounded-lg bg-gray-50 p-4 dark:bg-gray-800" id="reviews-panel" role="tabpanel">
