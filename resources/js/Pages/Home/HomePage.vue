        ...
        <div v-if="!isLoading" class="">
            ...
            <div class="md:w-4/6 2xl:w-4/6 mx-auto p-4">
                    ...
                    <div class="flex">
                        <div class="relative w-full">
                            <input @click.prevent="toggleSearch" type="search"
                                   ...
                                   placeholder="Search for a game or provider" required>
               ...
               <div class="mt-5 flex flex-col gap-3">
                <h1 class="text-xl font-bold">Popular games</h1>
                <div class="grid grid-cols-4 justify-center items-center gap-3 ">
                    <RouterLink to="/progmatik/game/fruit"><img class="rounded-lg transition-all duration-300 hover:scale-105 cursor-pointer active:scale-95" :src="`/assets/images/games/fruit_party_2.webp`" alt="" srcset=""></RouterLink>
                    <RouterLink to="/progmatik/game/olympus"><img class="rounded-lg transition-all duration-300 hover:scale-105 cursor-pointer active:scale-95" :src="`/assets/images/games/gates_of_olympus.webp`" alt="" srcset=""></RouterLink>
                    <RouterLink to="/progmatik/game/thedoghouse"><img class="rounded-lg transition-all duration-300 hover:scale-105 cursor-pointer active:scale-95" :src="`/assets/images/games/the_dog_house.webp`" alt="" srcset=""></RouterLink>
                    <RouterLink to="/progmatik/game/sweetbonanza"><img class="rounded-lg transition-all duration-300 hover:scale-105 cursor-pointer active:scale-95" :src="`/assets/images/games/sweet_bonanza_1000.webp`" alt="" srcset=""></RouterLink>
                </div>
                <div class="grid grid-cols-3 justify-center items-center gap-3 ">
                    <RouterLink to="/games/coin"><img class="rounded-lg transition-all duration-300 hover:scale-105 cursor-pointer active:scale-95" :src="`/assets/images/games/сoin_flip.png`" alt="" srcset=""></RouterLink>
                    <RouterLink to="/games/mines"><img class="rounded-lg transition-all duration-300 hover:scale-105 cursor-pointer active:scale-95" :src="`/assets/images/games/mines.png`" alt="" srcset=""></RouterLink>
                    <RouterLink to="/games/towers"><img class="rounded-lg transition-all duration-300 hover:scale-105 cursor-pointer active:scale-95" :src="`/assets/images/games/tower.png`" alt="" srcset=""></RouterLink>
                </div>

               </div>
                <div class="mt-5" v-if="featured_games">
