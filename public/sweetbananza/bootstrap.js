...
var UHT_SCRIPTS = [];
var UHT_STYLES = [];
var UHT_CLIENT_SIZES = 0;
var UHT_CLIENT_FILES = [];
var UHT_CLIENT_DOWNLOADED = 0;
var UHT_CLIENT_LOCALIZATION = null;
var UHT_GAME_SIZE = 0;
...
var UHTEventBroker = function() {
    var defaultConfig = {
        ...
        "SHORTCUT_NAME": "casino",
        "SHORTCUT_LINK": "https://studio.site.com/gs2c/mobile/casino/",
        "SHORTCUT_ICON_NAME": "ic_launcher.png",
        "SHORTCUT_URL_TO_RES": "/gs2c/res/brands/casino/shortcut/",
        "UPDATE_ANDROID_APP": "/gs2c/common/mobile_client/games/TheGameLibrary.apk",
        "UPDATE_ANDROID_PROP": "/gs2c/common/mobile_client/games/prop.info",
        "DEFAULTC": "0",
            ...
            if (xmlhttp.readyState == 4)
                if (xmlhttp.status == 200) {
                    ...
                    if (window["currentDatapathRetries"] >= window["retriesBeforeAlternativeDatapath"]) {
                        ...
                        if (!window["SENT_GA_EVENT_ALTERNATIVE_DATA_PATH"]) {
                            window["SENT_GA_EVENT_ALTERNATIVE_DATA_PATH"] = true;
                            window["globalTracking"]["SendEvent"]("uht_loading", "_USED_ALTERNATIVE_DATA_PATH", 1, "LoadingTracker")
                        }
                    } else
                        window["currentDatapathRetries"]++;
                    setTimeout(function() {
                        loadScript(url)
                    }, 250)
                }
...
function UHTVarsInjected() {
    var ProcessGameInfo = function() {
        ...
        UHT_GAME_SIZE += Number(window["UHT_SCRIPTS_SIZE"].split(":")[1].replace(",", ""));
        items = [];
        items = items.concat(String(UHT_CLIENT_SIZES).split(","));
        items = items.filter(function(x) {
            return x !== ""
        });
        files = [];
        ...
        for (var i = 0; i < items.length; ++i) {
            ...
            if (item.length > 1) {
                ...
                files[idx] = item[0].replace("?key=", ".json?key=");
                sizes[idx] = Number(item[1]);
                UHT_GAME_SIZE += sizes[idx]
            }
        }
        UHT_CLIENT_FILES = files;
        UHT_CLIENT_SIZES = sizes
    };
    ProcessGameInfo();
    ...
    ;
    window["PackageLoader"] = PackageLoader;
...
UHT_SCRIPTS_SIZE = 'build.js?key=7b9a963f02ae37748e7f9884b8db07f5:2996232,';
UHT_CLIENT_SIZES = 'game?key=1e14029b6b8674dd4aebcc80eecef690:22283,resources?key=29f7fe610047c4b016b5edf4ace2794e:76737,';
UHT_GAME_SIZE = 'game000?key=c493fbdb7fbbcda7fe7880ced1df1cc8:1506825,game001?key=3c0639242038baae593130aa09e637c4:1073014,game002?key=592f5a7f378e3e1c2b6e8cba6abd9f61:1101837,game003?key=cd22cb31ff3ee394b241b909faf69146:197511,';
UHT_RESOURCES_SIZE = 'main_resources000?key=66b25932c20fb2d16cc826b7dd0b59d9:1309844,main_resources001?key=1390e7744f4680387837b3d49f8de395:1945530,main_resources002?key=f47d90c7f14cec6fb69a203c8bf38bc2:576613,main_resources003?key=974c293428fca2efc441df6eb501b1fe:1790401,main_resources004?key=1ad60f2d199a033badaf14b2254ef0f4:1934353,main_resources005?key=5014e268f974f1fdda88ac28ce7bbc9b:2007718,main_resources006?key=ac7c16619d0b45029c9190148f17e150:560670,main_resources007?key=ba205312e007a12eb17de85